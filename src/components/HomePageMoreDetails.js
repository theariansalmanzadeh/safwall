...
function HomePageMoreDetails() {
  return (
    <div className={styles.moreDetails}>
      <div>
        <h2>Safwall</h2>
        <p>
          safwall is one of the most safest wallet created by now, supporting
          only goerli network{" "}
        </p>

        <p>it contains many feautres as following:</p>
        <ul>
          <li>
            <BsCheck className={styles.icon} />
            showing transactions and activities of wallet
          </li>
          <li>
            <BsCheck className={styles.icon} />
            sktaing and getting safwall's tokens{" "}
          </li>
          <li>
            <BsCheck className={styles.icon} />
            exporting keystore file(json) incase of losing the 12 phrase key
          </li>
          <li>
            <BsCheck className={styles.icon} />
            build in swap powered by Uniswap{" "}
          </li>
          <li>
            <BsCheck className={styles.icon} />
            keep tracking your favorite tokens
          </li>
        </ul>
        <p className={styles.cautions}>
          <IoWarningOutline className={styles.icon} />
          Caution: we highly recommend you to read the <span>
            how to use
          </span>{" "}
          section im order to know how to create your wallet
        </p>
      </div>
...
export default HomePageMoreDetails;
